...
airline$satisfaction <- gsub("neutral or dissatisfied", "dissatisfied", airline$satisfaction)
...
### comparing the percentages of satisfied and dissatisfied passengers within categories like gender, type of travel and class.
